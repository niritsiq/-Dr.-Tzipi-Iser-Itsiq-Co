...
const i18n = {
  he: {
    ...
    tzipiPhone: ' טלפון: 03-03000000',
    tzipiEmailLabel: ' דוא״ל: ',
    linkedinLabel: 'לינקדין: ',
    tzipiLinkedIn: 'ד"ר ציפי איסר איציק',
    ...
    talName: 'טל גרנות',
    talTitle: 'עורכת דין',
    talPhone: ' טלפון: 03-000000',
    talEmailLabel: ' דוא״ל: ',
    talLinkedIn: 'טל גרנות',
    talOffice: ' משרד: מגדל אייקון, דרך מנחם בגין 13, רמת גן',
    talPracticeTitle: 'תחומי עיסוק',
    talPracticeList: '<li>סביבה וקליימטק</li><li>ליטיגציה סביבתית (מנהלית, אזרחית ופלילית)</li><li>רגולציה ומדיניות סביבתית</li><li>עריכת הסכמים וליווי משפטי שוטף</li>',
    talExpTitle: 'ניסיון מקצועי',
    talExpBody: 'עו"ד טל גרנות היא עורכת דין המלווה תאגידים, רשויות ציבוריות וקהילות בתחומים של סביבה וקליימטק. טל בעלת ניסיון נרחב בתחום הסביבה, מתמחה בליווי סביבתי של הלקוח הכולל עריכת הסכמים, ליטיגציה סביבתית (מנהלית, אזרחית ופלילית), התנהלות מול הרגולטור ועוד.\nבמהלך שנות ניסיונה, טל עסקה בליווי משפטי סביבתי הן של פעילי סביבה וקהילות שונות, והן של תאגידים שונים, לצד פעילות של ניסוח וקידום חקיקה ועיסוק במדיניות רחבת היקף בתחום הסביבתי. נסיונה מאפשר לה ראיה רחבה של התחום באופן שיכול לסייע ללקוח גם בסוגיות מורכבות, תוך מתן מענה קשוב ובזמינות גבוהה.',
    talExpBody2: 'לפני הצטרפותה למשרד עבדה טל במחלקת סביבה ואקלים במשרד ליפא מאיר ושות\', ובעמותת אדם טבע ודין כעורכת דין וראש תחום בריאות וסביבה, שם הובילה אסטרטגיה לקידום מדיניות, ניסחה הצעות חוק וניהלה תיקים בפני ערכאות שיפוטיות שונות. לצד זאת הרצתה טל במוסדות אקדמיה בתחום של משפט וסביבה. קודם לכן עסקה בקידום זכויות בעמותת אלו"ט והתמחתה בפרקליטות מחוז מרכז.',
    talEduTitle: 'השכלה',
...
Areas of expertise include: environmental and climate law, environmental regulation and enforcement, ESG and corporate sustainability, administrative and public law litigation, infrastructure and energy projects, and advisory on cross‑border regulatory and climate‑related risks.`,
    ...
    tzipiLinkedIn: 'Dr. Tzipi Iser Itsiq',
    ...
    talTitle: 'Advocate',
    talEmailLabel: ' Email: ',
    talLinkedIn: 'Tal Granot',
    talOffice: ' Office: Icon Tower, 13 Menachem Begin Rd, Ramat Gan',
    talOffice: ' Office: Icon Tower, 13 Menachem Begin Rd, Ramat Gan',
    talPracticeTitle: 'Practice Areas',
    talPracticeList: '<li>Environment & Climate Tech</li><li>Environmental Litigation (Administrative, Civil, and Criminal)</li><li>Environmental Regulation & Policy</li><li>Agreements & Ongoing Legal Counsel</li>',
    talExpTitle: 'Professional Experience',
    talExpBody: 'Adv. Tal Granot advises corporations, public authorities, and communities in the fields of environment and climate tech. Tal possesses extensive experience in the environmental sector, specializing in comprehensive client support including agreement drafting, environmental litigation (administrative, civil, and criminal), and regulatory representation.\nThroughout her career, Tal has provided legal counsel to environmental activists, communities, and corporations alike, while also drafting legislation and advancing broad environmental policy. Her diverse background provides her with a holistic perspective of the field, enabling her to assist clients with complex issues while offering attentive and highly available service.',
    talExpBody2: 'Prior to joining the firm, Tal worked in the Environment and Climate Department at Lipa Meir & Co., and at "Adam Teva V\'Din" (Israel Union for Environmental Defense) as an attorney and Head of the Health and Environment Department. There, she led policy strategy, drafted bills, and managed cases before various courts. Additionally, Tal has lectured at academic institutions on law and the environment. Previously, she worked on rights promotion at ALUT and interned at the Central District Attorney\'s Office.',
